...
public class Main {
    public static void main(String[] args) throws IOException, UserNotFound, ParseException, CourseNotFound {
        ...
        LinkedHashMap<Course, Mark> linkedHashMap = new LinkedHashMap<>();
        linkedHashMap.put(course, new Mark());
